...
function showProject(category, projectId) {
    ...
    const categoryContainer = category === "ui" 
        ? document.querySelector(".btn-work").nextElementSibling.querySelectorAll(".project-image") 
        : document.querySelector(".btn-work-web").nextElementSibling.querySelectorAll(".project-image");

    categoryContainer.forEach((img) => {
        img.classList.remove("active");
        img.style.display = "none";
        img.style.animation = "none"; // Resetează animația
    });
    ...
    const buttonContainer = category === "ui" 
